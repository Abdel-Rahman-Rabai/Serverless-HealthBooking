...
export default {
  ...
  methods: {
    fetchAppointments() {
      fetch("https://wlosfeti0k.execute-api.us-east-1.amazonaws.com/new-stage/appointments")
        .then(res => res.json())
        .then(data => {
    ...
    updateStatus(appointment, newStatus) {
      ...
      const url = `https://wlosfeti0k.execute-api.us-east-1.amazonaws.com/new-stage/appointments/${appointment.appointmentId}`;
